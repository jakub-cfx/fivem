...
#ifdef _WIN32
// Supplementary wmain procedure for Windows builds, this is needed to correctly receive Unicode characters in argv[]
// Standard main(int argc, char* argv[]) treats input as ANSI instead of UTF8, reducing a lot of Unicode to question marks
int wmain(int argc, wchar_t* argv[])
{
	...
	// Set current locale to UTF8, this is needed for fopen() calls to function correctly with Unicode characters in paths
	// If this is not set, the Multibyte to Wide character conversion treats input as ANSI, thus no conversion happens
